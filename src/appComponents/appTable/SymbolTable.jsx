...
import ExporCSVModal from "../appModal/ExporCSVModal";
import BlockSymbolModal from "../appModal/BlockSymbolModal";

const SymbolTable = ({ data, loading }) => {
  ...
  return (
    <>
      {exportModal && (
        <BaseModal>
          <ExporCSVModal onClose={() => setExportModal(!exportModal)} />
        </BaseModal>
      )}
      {blockModal && (
        <BaseModal>
